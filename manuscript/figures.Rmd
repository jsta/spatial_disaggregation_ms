...
```{r tillage_map, fig.cap="Conservation tillage A) dissagregated to counties, B) at the original subbasin scale, C) aggregated to subregions. ", echo=FALSE, out.height = "6in"}
knitr::include_graphics("../figures/02_tillage_map-1.pdf")
```

```{r scatter_plot, fig.cap="Relationship between y at the subbasin scale and conservation tillage at A) the county scale, B) the subbasin scale, C) the subregion scale. ", echo=FALSE, out.height = "4in"}
